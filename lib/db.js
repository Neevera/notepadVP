// lib/db.js
// ─────────────────────────────────────────────────────────────
//  Koneksi ke Neon (PostgreSQL gratis)
//
//  Satu-satunya env variable yang dibutuhkan:
...
// tapi Neon connection pooler menangani ini secara efisien
...
// Neon sangat cepat, overhead CREATE TABLE IF NOT EXISTS sangat kecil
